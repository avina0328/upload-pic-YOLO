...
export default class NewLoginAndRegisterScreen extends Component {
  ...
  onClick_elButton_Login = (ev) => {
    // Go to screen 'FirstPage'
    this.props.appActions.goToScreen('firstpage', { transitionId: 'fadeIn' });
  
  }
  
  
  onClick_elButton_CreateNewAccount = (ev) => {
    // Go to screen 'NewVerifyEmail'
    this.props.appActions.goToScreen('newverifyemail', { transitionId: 'fadeIn' });
