...
export default class ChatroomScreen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen ChatroomScreen" style={baseStyle}>
        ...
        <div className="layoutFlow" style={layoutFlowStyle}>
          ...
          <div className='elText2' style={style_text2_outer}>
            <div style={style_text2}>
              <div>{this.props.locStrings.original3_text2_190288}</div>
            </div>
        ...
        <div className="screenFgContainer">
          <div className="foreground">
            ...
            <button className='elButtonCopy3' style={style_buttonCopy3}  onClick={this.onClick_elButtonCopy3} >
              {this.props.locStrings.original3_buttoncopy3_561001}
            </button>
            <button className='elButtonCopy2' style={style_buttonCopy2}  >
              {this.props.locStrings.original3_buttoncopy2_549345}
            </button>
            <button className='elButton' style={style_button}  >
              {this.props.locStrings.original3_button_26575}
            </button>
            <div className='font-arialRoundedMTBold  elTextCopy' style={style_textCopy}>
              <div>{this.props.locStrings.original3_textcopy_974115}</div>
            </div>
            <div className='font-arialRoundedMTBold  elText' style={style_text}>
              <div>{this.props.locStrings.original3_text_492781}</div>
            </div>
          </div>
        </div>
      </Container>
