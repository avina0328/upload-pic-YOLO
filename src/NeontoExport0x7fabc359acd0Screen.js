...
export default class NeontoExport0x7fabc359acd0Screen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen NeontoExport0x7fabc359acd0Screen" style={baseStyle}>
